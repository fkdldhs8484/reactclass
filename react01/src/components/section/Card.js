...
const cardText = [
  {
    ...
    imgClass: "assets/img/card_bg01_01.jpg",
  },
  {
    title: "웹표준 사이트 만들기",
    desc: "사이트를 만들기 위한 기초 강의입니다. 기본 코딩에 대한 감각을 익히고, 웹 표준을 준수하면서 코딩하는 방법을 익힙니다. 다양한 예제를 통해 사이트를 만드는 기본입니다.",
    imgClass: "assets/img/card_bg01_02.jpg",
  },
  {
    title: "웹표준 사이트 만들기",
    desc: "사이트를 만들기 위한 기초 강의입니다. 기본 코딩에 대한 감각을 익히고, 웹 표준을 준수하면서 코딩하는 방법을 익힙니다. 다양한 예제를 통해 사이트를 만드는 기본입니다.",
    imgClass: "assets/img/card_bg01_03.jpg",
  },
];

function CardInner({ title, desc, imgClass }) {
  return (
    <article className="card">
      <figure className="card__header">
        <img src={` ${imgClass}`} alt="웹표준 사이트 만들기" />
      </figure>
