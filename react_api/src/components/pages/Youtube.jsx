...
const Youtube = () => {
  ...
  const search = async (query) => {
    await fetch(
      `https://youtube.googleapis.com/youtube/v3/search/photos?api_key=3d606cf9dc17d29e0dec9772c8a629e6&languages=ko-kr&query=marvel&page=1&query=${query}$per_page=30`
    )
  ...
  useEffect(() => {
    fetch(
      "https://youtube.googleapis.com/youtube/v3/search?part=snippet&key=AIzaSyD9g0T8YJVNMnbu4l-CPnDzCjg0W3yKkx4&maxResults=30&type=video"
    )
      .then((response) => response.json())
